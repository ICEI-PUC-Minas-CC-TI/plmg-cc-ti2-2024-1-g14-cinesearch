...
public class FilmeService {
    ...
    public String buscarFilmes(Request req, Response res) {
        String query = req.queryParams("search");
        List<Filme> filmes = filmeDAO.buscarFilmes(query); // Ajustei para filmeDAO
    ...
    private class FilmeComGenero extends Filme {
        ...
        public FilmeComGenero(Filme filme) {
            ...
            this.setAno(filme.getAno());
            this.setDataLancamento(filme.getDataLancamento());
            this.setDuracao(filme.getDuracao());
            this.setSinopse(filme.getSinopse());
            this.setIdioma(filme.getIdioma());
            this.setPremios(filme.getPremios());
            this.setPoster(filme.getPoster());
            this.setNota(filme.getNota());
            this.setPopularidade(filme.getPopularidade());
        }
